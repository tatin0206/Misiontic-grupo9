...
var BulmaRadioGroup = function (_Component) {
  _inherits(BulmaRadioGroup, _Component);

  function BulmaRadioGroup(p) {
    _classCallCheck(this, BulmaRadioGroup);

    var _this = _possibleConstructorReturn(this, (BulmaRadioGroup.__proto__ || Object.getPrototypeOf(BulmaRadioGroup)).call(this, p));
  ...
  _createClass(BulmaRadioGroup, [{
    key: 'handleChange',
    value: function handleChange(event) {
      var _this2 = this;

      this.setState({ value: this.props.type(event.target.value) }, function () {
  ...
  return BulmaRadioGroup;
}(_react.Component);

exports.default = BulmaRadioGroup;
